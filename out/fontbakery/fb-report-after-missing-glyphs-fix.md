...
<details><summary>[7] Akt[wght].ttf</summary>
<div>
<details>
...
<td align="left">is_Latn (Icelandic), lt_Latn (Lithuanian) and pl_Latn (Polish)</td>
</tr>
</tbody>
</table>
...
<pre><code>- 0x0328 (COMBINING OGONEK)
</code></pre>
...
<li>U+0307 COMBINING DOT ABOVE: try adding one of: coptic, syriac, tai-le, canadian-aboriginal, malayalam, duployan, tifinagh, todhri, old-permic, hebrew, math</li>
...
<li>U+2010 HYPHEN: try adding one of: coptic, lisu, sora-sompeng, sundanese, syloti-nagri, armenian, kayah-li, kaithi, kharoshthi, hebrew, arabic, cham, yi</li>
...
<li>U+25CC DOTTED CIRCLE: try adding one of: khudawadi, tibetan, sogdian, kaithi, meetei-mayek, takri, soyombo, osage, thaana, manichaean, tagalog, music, balinese, mandaic, canadian-aboriginal, bengali, kayah-li, newa, javanese, phags-pa, devanagari, tai-tham, sinhala, telugu, kannada, grantha, cham, saurashtra, mongolian, buginese, marchen, coptic, malayalam, mahajani, bhaiksuki, elbasan, kharoshthi, gunjala-gondi, thai, masaram-gondi, brahmi, new-tai-lue, bassa-vah, gujarati, oriya, tamil, duployan, adlam, khmer, yi, modi, siddham, limbu, chakma, tagbanwa, dogra, khojki, sundanese, psalter-pahlavi, miao, tai-le, mende-kikakui, myanmar, nko, warang-citi, hanifi-rohingya, tirhuta, hanunoo, armenian, rejang, caucasian-albanian, lao, lepcha, syriac, gurmukhi, wancho, pahawh-hmong, tifinagh, symbols, batak, tai-viet, zanabazar-square, sharada, hebrew, ahom, syloti-nagri, old-permic, math, buhid</li>
