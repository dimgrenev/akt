...
<div>
<details>
    <summary>🔥 <b>FAIL</b> Verify that each group of fonts with the same nameID 1 has maximum of 4 fonts. <a href="https://fontbakery.readthedocs.io/en/stable/fontbakery/checks/opentype.html#opentype-family-max-4-fonts-per-family-name">opentype/family/max_4_fonts_per_family_name</a></summary>
    <div>
...
* 🔥 **FAIL** <p>Family 'Akt' has 9 fonts (should be 4 or fewer).</p>
 [code: too-many]
...
<li>U+0307 COMBINING DOT ABOVE: try adding one of: duployan, math, old-permic, coptic, canadian-aboriginal, syriac, hebrew, todhri, tai-le, tifinagh, malayalam</li>
