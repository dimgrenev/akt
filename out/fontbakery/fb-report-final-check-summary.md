...
<li>U+0307 COMBINING DOT ABOVE: try adding one of: duployan, syriac, canadian-aboriginal, malayalam, tai-le, tifinagh, todhri, math, old-permic, hebrew, coptic</li>
...
<li>U+2010 HYPHEN: try adding one of: sundanese, cham, syloti-nagri, kharoshthi, armenian, lisu, yi, arabic, kayah-li, kaithi, sora-sompeng, hebrew, coptic</li>
...
<li>U+25CC DOTTED CIRCLE: try adding one of: khmer, sundanese, soyombo, miao, mongolian, devanagari, chakma, meetei-mayek, hanunoo, lepcha, yi, masaram-gondi, buhid, manichaean, saurashtra, osage, adlam, batak, lao, mahajani, psalter-pahlavi, bhaiksuki, khojki, newa, khudawadi, marchen, takri, siddham, balinese, tamil, gujarati, caucasian-albanian, brahmi, sinhala, gurmukhi, symbols, hanifi-rohingya, hebrew, syriac, tai-tham, bassa-vah, old-permic, mandaic, tirhuta, malayalam, rejang, gunjala-gondi, grantha, wancho, armenian, dogra, phags-pa, tai-le, myanmar, tagbanwa, new-tai-lue, music, coptic, mende-kikakui, limbu, warang-citi, tagalog, tai-viet, elbasan, syloti-nagri, buginese, javanese, kayah-li, sogdian, kaithi, duployan, ahom, oriya, cham, bengali, modi, tifinagh, telugu, kannada, math, zanabazar-square, thai, nko, tibetan, canadian-aboriginal, thaana, sharada, kharoshthi, pahawh-hmong</li>
...
* uni2ABD (U+2ABD): X=556.0,Y=2.0 (should be at baseline 0?)

* uni2ABD (U+2ABD): X=293.0,Y=2.0 (should be at baseline 0?)

* uni2ABE (U+2ABE): X=527.0,Y=2.0 (should be at baseline 0?)

* uni2ABE (U+2ABE): X=264.0,Y=2.0 (should be at baseline 0?)
</code></pre>
