...
<li>U+0307 COMBINING DOT ABOVE: try adding one of: tai-le, hebrew, syriac, malayalam, todhri, math, coptic, duployan, old-permic, canadian-aboriginal, tifinagh</li>
...
<li>U+2010 HYPHEN: try adding one of: kharoshthi, lisu, syloti-nagri, hebrew, kayah-li, sora-sompeng, kaithi, coptic, yi, cham, arabic, sundanese, armenian</li>
...
<li>U+25CC DOTTED CIRCLE: try adding one of: sinhala, lao, music, psalter-pahlavi, buginese, brahmi, nko, hebrew, kayah-li, tai-viet, kannada, adlam, kharoshthi, khudawadi, new-tai-lue, saurashtra, warang-citi, kaithi, thai, khmer, limbu, sharada, ahom, siddham, zanabazar-square, modi, gujarati, tagbanwa, bassa-vah, sogdian, syriac, wancho, marchen, tagalog, batak, elbasan, gunjala-gondi, gurmukhi, duployan, khojki, armenian, tifinagh, newa, chakma, tai-tham, mende-kikakui, takri, bhaiksuki, sundanese, lepcha, canadian-aboriginal, masaram-gondi, coptic, balinese, symbols, hanifi-rohingya, mahajani, rejang, soyombo, old-permic, syloti-nagri, manichaean, meetei-mayek, osage, devanagari, dogra, telugu, mandaic, myanmar, tirhuta, caucasian-albanian, yi, bengali, javanese, oriya, cham, math, hanunoo, tai-le, buhid, mongolian, thaana, malayalam, phags-pa, miao, tibetan, grantha, pahawh-hmong, tamil</li>
...
<details><summary>[22] Akt-Bold.ttf</summary>
<div>
<details>
    <summary>🔥 <b>FAIL</b> Ensure glyphs do not have components which are themselves components. <a href="https://fontbakery.readthedocs.io/en/stable/fontbakery/checks/universal.html#nested-components">nested_components</a></summary>
    <div>
