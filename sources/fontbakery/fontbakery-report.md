...
<details><summary>[4] Akt[wght].ttf</summary>
<div>
<details>
...
<li>U+03CF GREEK CAPITAL KAI SYMBOL: try adding greek</li>
<li>U+03D7 GREEK KAI SYMBOL: try adding greek</li>
<li>U+03F3 GREEK LETTER YOT: try adding greek</li>
...
<pre><code>* Ccedilla (U+00C7): X=440.0,Y=-2.0 (should be at baseline 0?)

* uni019C (U+019C): X=466.5,Y=-2.0 (should be at baseline 0?)

* Oslash (U+00D8): X=458.5,Y=699.0 (should be at cap-height 700?)

* Oslashacute (U+01FE): X=458.5,Y=699.0 (should be at cap-height 700?)

* aringacute (U+01FB): X=175.0,Y=702.0 (should be at cap-height 700?)

* aringacute.cv01: X=205.0,Y=702.0 (should be at cap-height 700?)

* aringacute.ss01: X=175.0,Y=702.0 (should be at cap-height 700?)

* aringacute.ss01.cv01: X=205.0,Y=702.0 (should be at cap-height 700?)

* aringacute.ss02: X=175.0,Y=702.0 (should be at cap-height 700?)

* aringacute.ss02.cv01: X=205.0,Y=702.0 (should be at cap-height 700?)

* ae (U+00E6): X=656.5,Y=1.0 (should be at baseline 0?)

* aeacute (U+01FD): X=656.5,Y=1.0 (should be at baseline 0?)

* uni01E3 (U+01E3): X=656.5,Y=1.0 (should be at baseline 0?)

* ccedilla (U+00E7): X=346.0,Y=-2.0 (should be at baseline 0?)

* uni0292 (U+0292): X=386.0,Y=-2.0 (should be at baseline 0?)

* uni0292 (U+0292): X=482.0,Y=-2.0 (should be at baseline 0?)

* uni01EF (U+01EF): X=386.0,Y=-2.0 (should be at baseline 0?)

* uni01EF (U+01EF): X=482.0,Y=-2.0 (should be at baseline 0?)

* m (U+006D): X=373.5,Y=502.0 (should be at x-height 500?)

* uni02A4 (U+02A4): X=922.0,Y=-2.0 (should be at baseline 0?)

* uni02A4 (U+02A4): X=826.0,Y=-2.0 (should be at baseline 0?)

* uni026E (U+026E): X=602.0,Y=-2.0 (should be at baseline 0?)

* uni026E (U+026E): X=506.0,Y=-2.0 (should be at baseline 0?)

* uni0270 (U+0270): X=466.5,Y=-2.0 (should be at baseline 0?)

* uni026F (U+026F): X=466.5,Y=-2.0 (should be at baseline 0?)

* binferior: X=298.0,Y=-1.0 (should be at baseline 0?)

* dinferior: X=122.0,Y=-1.0 (should be at baseline 0?)

* gsuperior: X=241.5,Y=698.5 (should be at cap-height 700?)

* uni209A (U+209A): X=145.5,Y=-0.5 (should be at baseline 0?)

* uni209A (U+209A): X=298.0,Y=-0.5 (should be at baseline 0?)

* qinferior: X=122.0,Y=-0.5 (should be at baseline 0?)

* qinferior: X=274.5,Y=-0.5 (should be at baseline 0?)

* uni04A8 (U+04A8): X=529.5,Y=-2.0 (should be at baseline 0?)

* uni0431.loclSRB: X=344.5,Y=699.5 (should be at cap-height 700?)

* uni0431.loclSRB: X=442.0,Y=698.5 (should be at cap-height 700?)

* uni0437.loclBGR: X=386.0,Y=-2.0 (should be at baseline 0?)

* uni0437.loclBGR: X=386.0,Y=2.0 (should be at baseline 0?)

* uni0437.loclBGR: X=482.0,Y=2.0 (should be at baseline 0?)

* uni0437.loclBGR: X=482.0,Y=-2.0 (should be at baseline 0?)

* uni0448.loclBGR: X=466.5,Y=-2.0 (should be at baseline 0?)

* uni0449.loclBGR: X=470.5,Y=-2.0 (should be at baseline 0?)

* uni04AB (U+04AB): X=344.0,Y=-2.0 (should be at baseline 0?)

* uni04AB.loclBSH: X=344.0,Y=-2.0 (should be at baseline 0?)

* uni04AB.loclCHU: X=344.0,Y=-2.0 (should be at baseline 0?)

* uni04D5 (U+04D5): X=656.5,Y=1.0 (should be at baseline 0?)

* uni04E1 (U+04E1): X=386.0,Y=-2.0 (should be at baseline 0?)

* uni04E1 (U+04E1): X=482.0,Y=-2.0 (should be at baseline 0?)
...
* braceleft.case: X=261.5,Y=-0.5 (should be at baseline 0?)

* braceright.case: X=219.0,Y=-0.5 (should be at baseline 0?)

* uni2101 (U+2101): X=669.0,Y=2.0 (should be at baseline 0?)

* ampersand (U+0026): X=414.0,Y=2.0 (should be at baseline 0?)

* uni030A0301: X=115.0,Y=702.0 (should be at cap-height 700?)

* uni0351 (U+0351): X=94.5,Y=701.0 (should be at cap-height 700?)

* uni0357 (U+0357): X=206.0,Y=701.0 (should be at cap-height 700?)
</code></pre>
